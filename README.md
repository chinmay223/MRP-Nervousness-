...
# ── Run WITHOUT SS rolling MRP (needed for Graph 3) ───────────────
...
# Grouped bar chart — L4L (blue) vs Fixed Lot (orange) per component
# Exactly matching Image 1
# ══════════════════════════════════════════════════════════════════
...
# Line chart tracking one component's PO for one week across runs
# Exactly matching Image 3
# ══════════════════════════════════════════════════════════════════
...
# 4-line chart exactly matching Image 2
# Solid = with SS, Dashed = without SS
# Blue = L4L, Orange = Fixed Lot
# ══════════════════════════════════════════════════════════════════
...
# files.download('Policy_Comparison_for_Nervousness.png')
# files.download('SS_comparison_across_policies.png')
# files.download('Stability_of_policies_compared.png')
